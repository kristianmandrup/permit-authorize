...
(function(){
  var requires, expect, authorize, Ability, PermitRulesLoader, User, Book, user, book, ability, aBook, currentUser;
  ...
  describe('index', function(){
    ...
    return describe('PermitRulesLoader', function(){
      return specify('is class', function(){
        return expect(new PermitRulesLoader('xyz').filePath).to.eql('xyz');
      });
    });
  });
}).call(this);
