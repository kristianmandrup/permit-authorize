...
(function(){
  var requires, User, Book, RulesApplier, RuleRepo, fixRules, createRulesApplier, createRepo, createExecCtx;
  ...
  describe('Rule Applier (RuleApplier)', function(){
    ...
    return describe('dynamic', function(){
      ...
      before(function(){
        ...
        ruleApplier = createRulesApplier(createExecCtx(), rules, readAccessRequest, true);
