...
(function(){
  var requires, Matcher, PermitRegistry, setup, Book, User, createUser, createMatcher, intersect, excludes, users, permits, requests, ctx, matching, noneMatching;
  ...
  describe('ContextMatcher - Exclude', function(){
    return describe.only('excludes - Function ', function(){
