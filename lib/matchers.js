...
(function(){
  var requires, Intersect, _, lo, Debugger, BaseMatcher, ActionMatcher, UserMatcher, SubjectMatcher, ContextMatcher, AccessMatcher;
  ...
  AccessMatcher = (function(){
    ...
    prototype.matchOn = function(hash){
      ...
      all = hash;
      for (i$ = 0, len$ = (ref$ = _.keys(hash)).length; i$ < len$; ++i$) {
        key = ref$[i$];
        matchFun = this[key];
        matchValue = hash[key];
        if (_.isType('Function', matchFun)) {
          delete all[key];
