...
(function(){
  var requires, _, lo, Permit, PermitRegistry, Debugger, PermitFilter;
  ...
  module.exports = PermitFilter = (function(){
    ...
    PermitFilter.filter = function(accessRequest){
      ...
      res = _.filter(matchingFun, permits);
      this.debug('filtered', res);
      return res;
    };
    PermitFilter.permits = function(){
      return _.values(PermitRegistry.permits);
    };
