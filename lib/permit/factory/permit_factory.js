...
(function(){
  var PermitFactory, toString$ = {}.toString;
  module.exports = PermitFactory = (function(){
    ...
    prototype.create = function(){
      var permit;
      if (toString$.call(this.baseObj).slice(8, -1) === 'Function') {
        this.baseObj = this.baseObj();
      }
      if (toString$.call(baseObj).slice(8, -1) === 'Object') {
        permit = this.use(this.createPermit(), this.baseObj);
      }
      return permit.init();
    };
