...
(function(){
  var rule, util, RulesAccessor, camelCase, Debugger, StaticApplier, DynamicApplier, ExecutionContext, PermitRuleApplier, toString$ = {}.toString;
  rule = require('../../rule');
  util = require('../../util');
  ...
  module.exports = PermitRuleApplier = (function(){
    ...
    prototype.executionContext = function(){
      return this._executer || (this._executer = new ExecutionContext(this.ctx.repo(), this.debugging));
    };
