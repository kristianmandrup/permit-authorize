...
(function(){
  var Intersect, AccessMatcher, Debugger, UsePermitMatcher, toString$ = {}.toString;
  Intersect = require('../../util').Intersect;
  AccessMatcher = require('../../access_request').matcher.AccessMatcher;
  Debugger = require('../../util').Debugger;
  module.exports = UsePermitMatcher = (function(){
    UsePermitMatcher.displayName = 'UsePermitMatcher';
    var prototype = UsePermitMatcher.prototype, constructor = UsePermitMatcher;
    importAll$(prototype, arguments[0]);
    function UsePermitMatcher(permit, accessRequest, debugging){
      this.permit = permit;
    ...
    return UsePermitMatcher;
  }(Debugger));
  import$(UsePermitMatcher, Debugger);
