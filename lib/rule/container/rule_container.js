...
(function(){
  var util, Debugger, RuleContainer;
  util = require('../../util');
  ...
  module.exports = RuleContainer = (function(){
    ...
    prototype.matcher = function(act, accessRequest){
      return new RuleMatcher(this.container, act, accessRequest);
    };
    prototype.cleaner = function(){
      return this._cleaner || (this._cleaner = new RepoCleaner(this.container));
    };
    prototype.registrator = function(){
      return this._registrator || (this._registrator = new RuleRegistrator(this.container));
    };
