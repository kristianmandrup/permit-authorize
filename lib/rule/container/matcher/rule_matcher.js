...
(function(){
  ...
  module.exports = RuleMatcher = (function(){
    ...
    function RuleMatcher(container, act, accessRequest){
    ...
    prototype.managedSubjectMatch = function(){
      return this.managedSubjectMatcher().match(this.subject);
    };
    prototype.managedSubjectMatcher = function(){
      return new ManagedSubjectMatcher(this.actContainer());
    };
    prototype.matchSubject = function(){
      return this.subjectMatcher().match(this.subject);
    };
    prototype.subjectMatcher = function(){
      return new RuleSubjectMatcher(this.actionSubjects());
    };
    prototype.actionSubjects = function(){
      return this._actionSubjects || (this._actionSubjects = this.container[this.action]);
    };
