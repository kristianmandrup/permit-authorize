...
(function(){
  var Ability, FingerPrinter, Debugger, CachedAbility, slice$ = [].slice;
  Ability = require('./ability');
  FingerPrinter = require('../access_request').fingerprint.FingerPrinter;
  Debugger = require('../util').Debugger;
  CachedAbility = (function(superclass){
    ...
    prototype.userHash = function(){
      return new FingerPrinter(user).userHash();
    };
